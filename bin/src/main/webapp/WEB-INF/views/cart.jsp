		...
		<h1>${gioHang.total}</h1>
			<div>
				<c:forEach var="item" items="${gioHang.items}">
						<h3>Id: ${item.prod.product_id}</h3>
						<h3>Tên sp: ${item.prod.product_name}</h3>
						<h3>Tên sp: ${item.prod.product_price}</h3>
						<h3>Số lượng:</h3>
                                            ...
                                            <div>
												...
												<form style="float:left;" action="cart/update.htm" method="post">
															...
															<div style="position:relative; float:left; margin:-2px 0px;" class="input-group">
															  ...
															  <input style="position:relative; max-height:34px; margin:0px 3.5px; "  type="number" step="1" min="1" value="${item.quantity}" name="quantity" class="quantity-field">
												...
												Thành tiền: <fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${item.subTotal}" /> VND</p>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li style="font-size:20px;" class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mb-3">
                                    ...
                                    <span><strong><span > <fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${gioHang.total}" /></span> VND</strong></span>
                                </li>
                            </ul>
